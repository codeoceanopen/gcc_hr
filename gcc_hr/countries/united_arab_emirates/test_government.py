...
from gcc_hr.countries.united_arab_emirates.government import (
	generate_emiratisation_report,
	generate_wps_report,
	validate_emiratisation_report,
	validate_wps_report,
)

TEST_COMPANY = "_Test GCC UAE Government Co"


class TestUAEGovernment(FrappeTestCase):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_generate_emiratisation_report_reflects_emiratisation_profile(self):
		recalculate(TEST_COMPANY)
		result = generate_emiratisation_report(TEST_COMPANY)
	...
	def test_generate_emiratisation_report_fails_without_profile(self):
		with self.assertRaises(frappe.ValidationError):
			generate_emiratisation_report("_Test GCC Nonexistent Co")

	def test_validate_emiratisation_report_fails_without_profile(self):
		errors = validate_emiratisation_report("_Test GCC Nonexistent Co")
		self.assertTrue(errors)

	def test_validate_emiratisation_report_passes_after_recalculate(self):
		recalculate(TEST_COMPANY)
		errors = validate_emiratisation_report(TEST_COMPANY)
	...
	def test_generate_wps_report_lists_active_employees(self):
		employee = frappe.get_doc(
			{
				"doctype": "Employee",
				"first_name": "Test UAE Gov Employee",
