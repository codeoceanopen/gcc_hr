...
"""Bahrain-specific employee identity. Dispatched generically from
...
this module is never imported directly by core."""

import frappe


def sync_employee(employee_doc):
	if frappe.db.exists("Bahrain Employee Profile", employee_doc.name):
		return
	frappe.get_doc(
		{
